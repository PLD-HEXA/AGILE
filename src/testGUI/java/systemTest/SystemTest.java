...
public class SystemTest {
    ...
    public void loadFiles() throws InterruptedException {
        Thread.sleep(1000);
        utils.setInputViewOrigin(controller.getMainWindow().getInputView());
        utils.setGraphicalViewOrigin(controller.getMainWindow().getGraphicalView());
    ...
    public void launchDemo() throws InterruptedException {
        ...
        List<Itinerary> deliveries = controller.getMainWindow().getGraphicalView().getItineraries();
        Coordinate coordinate = deliveries.get(0).getGeneralPath().get(0).getCoordinate();
        double[] positions = controller.getMainWindow().getGraphicalView().getCoordinatePosition(coordinate);
        ...
        positions = controller.getMainWindow().getGraphicalView().getCoordinatePosition(lastCoordinate);
        utils.clickOnCoordinate(positions[0], positions[1]);
        Thread.sleep(1000);
