 ...
 * @author PLD-HEXA-301
 *
 * class {@NCode Reseau} represents an object that has the same structure as 
 * the analyzed XML City plan file.
 * The parsed XML file has a root tag: {@Code Reseau}
 */
...
public class Reseau {
    ...
    /**
      * Constructor of {@Code Reseau} with the attributes
      * {@code node} and {@code troncon}initialized.
      *
