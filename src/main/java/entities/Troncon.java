 ...
 * @author PLD-HEXA-301
 * 
 * The class {@Code Troncon} represents an object that has the same structure 
 * as the element represented by the {@code troncon} tag in the parsed 
 * City plan XML file.
 *
 */
public class Troncon {
    ...
    /**
    * Contains the destination represented by the {@code destination}
    ...
    */
    ...
    /**
    * Constructor of {@Troncon} with the attributes {@code destination},
    ...
    *
    * @return a string that represents the id of the destination of the segment.
    */
