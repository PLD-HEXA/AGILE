 ...
 * as the elementrepresented by the {@code Livraison} tag 
 * in the parsed DeliveryPoints XML file.
 */
public class Livraison {
	
    /** 
     * contains the delivery address represented by the 
     * {@code adresse} attribute of the tag {@code Livraison}  
    */
    ...
    /**
     * Constructor of {@code Livraison} object that represents 
     * an object with the attributes {@code addresse} and {@code duree} initialized.
     * 
...
    */
     ...
     * 
     * @return a string that represents the delivery address (id of the delivery
     */ 
    public String getId() {
            return adresse;
    }
